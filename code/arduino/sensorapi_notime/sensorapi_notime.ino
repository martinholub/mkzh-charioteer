...
/* This driver uses the Adafruit unified sensor library (Adafruit_Sensor),
   ...
   Connections
   ===========
   Connect SCL-LRX to analog 5
   Connect SDA-ATX to analog 4
...
/*
 ...
 ATX    →  LVx → HVx  →   TTN UNO SDA  (2) | 4 on ArdUNO
 LRX    →  LVx → HVx  →   TTN UNO SCL  (3) | 5 on ArdUNO
...
//  Serial.print("QuatZ: "); Serial.print(quat.z(), 4);  Serial.println();
